...
export const translations: { [lang: string]: { [key: string]: string } } = {
  ...
  en: {
    ...
    'all_planned_visits_completed': 'All planned visits completed',
    'all_clients': 'All Clients',
    'show_planned_visits': 'Show Planned Visits',
    'choose_region': 'Choose Region',
    'choose_doctor': 'Choose Doctor',
    'search_for_pharmacy': 'Search for pharmacy...',
    'products_select_limit': 'Select Products (Max 3)',
    'products_label': 'Products',
    'coaching_single_select': 'Visit Type (Coaching/Single)',
    'Coaching': 'Coaching',
    'Single': 'Single',
    ...
    'error_add_notes': 'Please add notes',
    'error_select_product': 'Please select at least one product',
    'error_select_visit_type': 'Please select visit type',
